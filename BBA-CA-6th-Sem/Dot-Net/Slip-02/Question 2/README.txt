...
- Write a C#.Net program to create a base class Department and derived classes Sales and Human Resource. Accept the details of both departments and display them in proper format. [25 M]
...
- ASP.NET Web Forms with C#; controls used: TextBox, Label.
