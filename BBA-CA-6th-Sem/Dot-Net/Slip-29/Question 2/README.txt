...
- Write a VB.NET program to accept the details of customer (CName, Contact No, Email_id). Store it into the database with proper validation and display appropriate message by using Message box. [25 M]
...
- ASP.NET Web Forms with C#; controls used: TextBox, Label, RequiredFieldValidator, RegularExpressionValidator, CompareValidator, GridView, SqlDataSource.
