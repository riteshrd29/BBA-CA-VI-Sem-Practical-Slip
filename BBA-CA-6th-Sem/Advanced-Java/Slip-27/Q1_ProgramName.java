// Question: Write a JSP script to accept the details of Teacher (TID, TName, Desg, Subject , Qualification) and display it on the browser. Use appropriate controls for accepting data. [15 M]
import java.io.*;
import java.sql.*;
import java.time.*;
