// Question: Write a Java program to design a following screen: Select Emp No If user selects EmpNo from Choice component then details of selected employee must be displayed in JTable. [25 M]
import javax.swing.*;
import java.awt.*;
import java.time.*;
