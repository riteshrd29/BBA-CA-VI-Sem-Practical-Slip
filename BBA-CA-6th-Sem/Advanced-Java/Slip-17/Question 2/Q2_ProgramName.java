// Question: Write a Java program to check whether given file is present on server or not, if it is there then display its contents on client’s terminal otherwise display the message “File Not Found”. [25 M]
import java.io.*;
import java.net.*;
import java.time.*;
import java.util.*;
