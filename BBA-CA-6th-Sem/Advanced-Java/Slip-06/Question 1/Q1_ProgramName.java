// Question: Write a java program to blink image on the Frame continuously. [15 M]
import javax.swing.*;
import java.awt.*;
import java.time.*;
public class Q1_ProgramName extends JFrame {
    int x = 0, dir = 1;
    Timer timer;
    String mode = "blinking_image";
    public Q1_ProgramName() {
        setSize(500, 300);
    ...
    public static void main(String[] a) { new Q1_ProgramName(); }
}
